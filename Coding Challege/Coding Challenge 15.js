...
const displayResultData1 = poll.displayResult.bind(data1);
const displayResultData2 = poll.displayResult.bind(data2);
displayResultData1();
displayResultData1('string');
displayResultData2();
displayResultData2('string');
